      ...
      <div class="menu-header">
        <div class="dsk-logo">
          <a class="nav-brand" href="index.html">
            ...
            />
            <img src="{{ asset('/frontend') }}/images/logo.png" alt="Logo" class="mega-darks-logo" />
          </a>
        </div>
        <div class="custom-nav" role="navigation">
          <ul class="nav-list">
            ...
            <li class="sbmenu rpdropdown">
              <a href="./potfolio.html" class="menu-links">Portfolio</a>
            </li>
            <li class="sbmenu">
          ...
          <ul class="nav-list right-end-btn">
            <!-- <li class="hidemobile">
              <a
                ...
                class="btn-round- btn-br bg-btn2"
                ><i class="fas fa-phone-alt"></i
              ></a>
            </li> -->
            <li class="hidemobile">
              <a href="get-quote.html" class="btn-br bg-btn3 btshad-b2 lnk"
