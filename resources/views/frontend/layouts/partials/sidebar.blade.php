    ...
    <div class="offcanvas-body">
      ...
      <div class="getintouchblock mt30">
        ...
        <div class="media mt15">
          <div class="icondive">
            <img src="{{ asset('/frontend') }}/images/icons/call.svg" alt="icon" />
          </div>
          <div class="media-body getintouchinfo">
            <a href="tel:123456790"
              >+91-123 4567 890 <span>Mon-Fri 9am - 6pm</span></a
            >
          </div>
        </div>
        <div class="media mt15">
          <div class="icondive">
            <img src="{{ asset('/frontend') }}/images/icons/whatsapp.svg" alt="icon" />
          </div>
          <div class="media-body getintouchinfo">
            <a href="tel:123456790"
              >+91-123 4567 890 <span>Mon-Fri 9am - 6pm</span></a
        ...
        <div class="media mt15">
          <div class="icondive">
            <img src="{{ asset('/frontend') }}/images/icons/mail.svg" alt="icon" />
          </div>
          <div class="media-body getintouchinfo">
            <a href="mailto:info@website.com"
              >info@website.com <span>Online Support</span></a
            >
          </div>
        </div>
        <div class="media mt15">
          <div class="icondive">
            <img src="{{ asset('/frontend') }}/images/icons/map.svg" alt="icon" />
          </div>
          <div class="media-body getintouchinfo">
            <a href="mailto:info@website.com"
              >Jaipur, Rajasthan, India<span>Visit Our Office</span></a
            >
          </div>
        </div>
      </div>
